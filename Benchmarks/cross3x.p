...
fof(bind_fn_a_a_pair_a_a, axiom, (m_fn_a_a => (((a => a) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_a_a_pair_a_b, axiom, (m_fn_a_a => (((a => a) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_a_a_pair_a_m_a, axiom, (m_fn_a_a => (((a => a) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_a_a_pair_a_m_b, axiom, (m_fn_a_a => (((a => a) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_a_a_pair_b_a, axiom, (m_fn_a_a => (((a => a) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_a_a_pair_b_b, axiom, (m_fn_a_a => (((a => a) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_a_a_pair_b_m_a, axiom, (m_fn_a_a => (((a => a) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_a_a_pair_b_m_b, axiom, (m_fn_a_a => (((a => a) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_a_a_pair_m_a_a, axiom, (m_fn_a_a => (((a => a) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_a_a_pair_m_a_b, axiom, (m_fn_a_a => (((a => a) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_a_a_pair_m_a_m_a, axiom, (m_fn_a_a => (((a => a) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_a_a_pair_m_a_m_b, axiom, (m_fn_a_a => (((a => a) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_a_a_pair_m_b_a, axiom, (m_fn_a_a => (((a => a) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_a_a_pair_m_b_b, axiom, (m_fn_a_a => (((a => a) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_a_a_pair_m_b_m_a, axiom, (m_fn_a_a => (((a => a) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_a_a_pair_m_b_m_b, axiom, (m_fn_a_a => (((a => a) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_a_b_pair_a_a, axiom, (m_fn_a_b => (((a => b) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_a_b_pair_a_b, axiom, (m_fn_a_b => (((a => b) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_a_b_pair_a_m_a, axiom, (m_fn_a_b => (((a => b) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_a_b_pair_a_m_b, axiom, (m_fn_a_b => (((a => b) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_a_b_pair_b_a, axiom, (m_fn_a_b => (((a => b) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_a_b_pair_b_b, axiom, (m_fn_a_b => (((a => b) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_a_b_pair_b_m_a, axiom, (m_fn_a_b => (((a => b) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_a_b_pair_b_m_b, axiom, (m_fn_a_b => (((a => b) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_a_b_pair_m_a_a, axiom, (m_fn_a_b => (((a => b) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_a_b_pair_m_a_b, axiom, (m_fn_a_b => (((a => b) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_a_b_pair_m_a_m_a, axiom, (m_fn_a_b => (((a => b) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_a_b_pair_m_a_m_b, axiom, (m_fn_a_b => (((a => b) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_a_b_pair_m_b_a, axiom, (m_fn_a_b => (((a => b) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_a_b_pair_m_b_b, axiom, (m_fn_a_b => (((a => b) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_a_b_pair_m_b_m_a, axiom, (m_fn_a_b => (((a => b) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_a_b_pair_m_b_m_b, axiom, (m_fn_a_b => (((a => b) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_a_m_a_pair_a_a, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_a_m_a_pair_a_b, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_a_m_a_pair_a_m_a, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_a_m_a_pair_a_m_b, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_a_m_a_pair_b_a, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_a_m_a_pair_b_b, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_a_m_a_pair_b_m_a, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_a_m_a_pair_b_m_b, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_a_m_a_pair_m_a_a, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_a_m_a_pair_m_a_b, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_a_m_a_pair_m_a_m_a, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_a_m_a_pair_m_a_m_b, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_a_m_a_pair_m_b_a, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_a_m_a_pair_m_b_b, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_a_m_a_pair_m_b_m_a, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_a_m_a_pair_m_b_m_b, axiom, (m_fn_a_m_a => (((a => m_a) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_a_m_b_pair_a_a, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_a_m_b_pair_a_b, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_a_m_b_pair_a_m_a, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_a_m_b_pair_a_m_b, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_a_m_b_pair_b_a, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_a_m_b_pair_b_b, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_a_m_b_pair_b_m_a, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_a_m_b_pair_b_m_b, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_a_m_b_pair_m_a_a, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_a_m_b_pair_m_a_b, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_a_m_b_pair_m_a_m_a, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_a_m_b_pair_m_a_m_b, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_a_m_b_pair_m_b_a, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_a_m_b_pair_m_b_b, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_a_m_b_pair_m_b_m_a, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_a_m_b_pair_m_b_m_b, axiom, (m_fn_a_m_b => (((a => m_b) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_b_a_pair_a_a, axiom, (m_fn_b_a => (((b => a) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_b_a_pair_a_b, axiom, (m_fn_b_a => (((b => a) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_b_a_pair_a_m_a, axiom, (m_fn_b_a => (((b => a) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_b_a_pair_a_m_b, axiom, (m_fn_b_a => (((b => a) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_b_a_pair_b_a, axiom, (m_fn_b_a => (((b => a) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_b_a_pair_b_b, axiom, (m_fn_b_a => (((b => a) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_b_a_pair_b_m_a, axiom, (m_fn_b_a => (((b => a) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_b_a_pair_b_m_b, axiom, (m_fn_b_a => (((b => a) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_b_a_pair_m_a_a, axiom, (m_fn_b_a => (((b => a) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_b_a_pair_m_a_b, axiom, (m_fn_b_a => (((b => a) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_b_a_pair_m_a_m_a, axiom, (m_fn_b_a => (((b => a) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_b_a_pair_m_a_m_b, axiom, (m_fn_b_a => (((b => a) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_b_a_pair_m_b_a, axiom, (m_fn_b_a => (((b => a) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_b_a_pair_m_b_b, axiom, (m_fn_b_a => (((b => a) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_b_a_pair_m_b_m_a, axiom, (m_fn_b_a => (((b => a) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_b_a_pair_m_b_m_b, axiom, (m_fn_b_a => (((b => a) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_b_b_pair_a_a, axiom, (m_fn_b_b => (((b => b) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_b_b_pair_a_b, axiom, (m_fn_b_b => (((b => b) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_b_b_pair_a_m_a, axiom, (m_fn_b_b => (((b => b) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_b_b_pair_a_m_b, axiom, (m_fn_b_b => (((b => b) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_b_b_pair_b_a, axiom, (m_fn_b_b => (((b => b) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_b_b_pair_b_b, axiom, (m_fn_b_b => (((b => b) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_b_b_pair_b_m_a, axiom, (m_fn_b_b => (((b => b) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_b_b_pair_b_m_b, axiom, (m_fn_b_b => (((b => b) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_b_b_pair_m_a_a, axiom, (m_fn_b_b => (((b => b) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_b_b_pair_m_a_b, axiom, (m_fn_b_b => (((b => b) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_b_b_pair_m_a_m_a, axiom, (m_fn_b_b => (((b => b) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_b_b_pair_m_a_m_b, axiom, (m_fn_b_b => (((b => b) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_b_b_pair_m_b_a, axiom, (m_fn_b_b => (((b => b) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_b_b_pair_m_b_b, axiom, (m_fn_b_b => (((b => b) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_b_b_pair_m_b_m_a, axiom, (m_fn_b_b => (((b => b) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_b_b_pair_m_b_m_b, axiom, (m_fn_b_b => (((b => b) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_b_m_a_pair_a_a, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_b_m_a_pair_a_b, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_b_m_a_pair_a_m_a, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_b_m_a_pair_a_m_b, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_b_m_a_pair_b_a, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_b_m_a_pair_b_b, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_b_m_a_pair_b_m_a, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_b_m_a_pair_b_m_b, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_b_m_a_pair_m_a_a, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_b_m_a_pair_m_a_b, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_b_m_a_pair_m_a_m_a, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_b_m_a_pair_m_a_m_b, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_b_m_a_pair_m_b_a, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_b_m_a_pair_m_b_b, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_b_m_a_pair_m_b_m_a, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_b_m_a_pair_m_b_m_b, axiom, (m_fn_b_m_a => (((b => m_a) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_b_m_b_pair_a_a, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_b_m_b_pair_a_b, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_b_m_b_pair_a_m_a, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_b_m_b_pair_a_m_b, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_b_m_b_pair_b_a, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_b_m_b_pair_b_b, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_b_m_b_pair_b_m_a, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_b_m_b_pair_b_m_b, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_b_m_b_pair_m_a_a, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_b_m_b_pair_m_a_b, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_b_m_b_pair_m_a_m_a, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_b_m_b_pair_m_a_m_b, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_b_m_b_pair_m_b_a, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_b_m_b_pair_m_b_b, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_b_m_b_pair_m_b_m_a, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_b_m_b_pair_m_b_m_b, axiom, (m_fn_b_m_b => (((b => m_b) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_m_a_a_pair_a_a, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_m_a_a_pair_a_b, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_m_a_a_pair_a_m_a, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_m_a_a_pair_a_m_b, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_m_a_a_pair_b_a, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_m_a_a_pair_b_b, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_m_a_a_pair_b_m_a, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_m_a_a_pair_b_m_b, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_m_a_a_pair_m_a_a, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_m_a_a_pair_m_a_b, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_m_a_a_pair_m_a_m_a, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_m_a_a_pair_m_a_m_b, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_m_a_a_pair_m_b_a, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_m_a_a_pair_m_b_b, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_m_a_a_pair_m_b_m_a, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_m_a_a_pair_m_b_m_b, axiom, (m_fn_m_a_a => (((m_a => a) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_m_a_b_pair_a_a, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_m_a_b_pair_a_b, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_m_a_b_pair_a_m_a, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_m_a_b_pair_a_m_b, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_m_a_b_pair_b_a, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_m_a_b_pair_b_b, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_m_a_b_pair_b_m_a, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_m_a_b_pair_b_m_b, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_m_a_b_pair_m_a_a, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_m_a_b_pair_m_a_b, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_m_a_b_pair_m_a_m_a, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_m_a_b_pair_m_a_m_b, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_m_a_b_pair_m_b_a, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_m_a_b_pair_m_b_b, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_m_a_b_pair_m_b_m_a, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_m_a_b_pair_m_b_m_b, axiom, (m_fn_m_a_b => (((m_a => b) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_m_a_m_a_pair_a_a, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_m_a_m_a_pair_a_b, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_m_a_m_a_pair_a_m_a, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_m_a_m_a_pair_a_m_b, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_m_a_m_a_pair_b_a, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_m_a_m_a_pair_b_b, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_m_a_m_a_pair_b_m_a, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_m_a_m_a_pair_b_m_b, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_m_a_m_a_pair_m_a_a, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_m_a_m_a_pair_m_a_b, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_m_a_m_a_pair_m_a_m_a, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_m_a_m_a_pair_m_a_m_b, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_m_a_m_a_pair_m_b_a, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_m_a_m_a_pair_m_b_b, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_m_a_m_a_pair_m_b_m_a, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_m_a_m_a_pair_m_b_m_b, axiom, (m_fn_m_a_m_a => (((m_a => m_a) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_m_a_m_b_pair_a_a, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_m_a_m_b_pair_a_b, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_m_a_m_b_pair_a_m_a, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_m_a_m_b_pair_a_m_b, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_m_a_m_b_pair_b_a, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_m_a_m_b_pair_b_b, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_m_a_m_b_pair_b_m_a, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_m_a_m_b_pair_b_m_b, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_m_a_m_b_pair_m_a_a, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_m_a_m_b_pair_m_a_b, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_m_a_m_b_pair_m_a_m_a, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_m_a_m_b_pair_m_a_m_b, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_m_a_m_b_pair_m_b_a, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_m_a_m_b_pair_m_b_b, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_m_a_m_b_pair_m_b_m_a, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_m_a_m_b_pair_m_b_m_b, axiom, (m_fn_m_a_m_b => (((m_a => m_b) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_m_b_a_pair_a_a, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_m_b_a_pair_a_b, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_m_b_a_pair_a_m_a, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_m_b_a_pair_a_m_b, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_m_b_a_pair_b_a, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_m_b_a_pair_b_b, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_m_b_a_pair_b_m_a, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_m_b_a_pair_b_m_b, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_m_b_a_pair_m_a_a, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_m_b_a_pair_m_a_b, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_m_b_a_pair_m_a_m_a, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_m_b_a_pair_m_a_m_b, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_m_b_a_pair_m_b_a, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_m_b_a_pair_m_b_b, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_m_b_a_pair_m_b_m_a, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_m_b_a_pair_m_b_m_b, axiom, (m_fn_m_b_a => (((m_b => a) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_m_b_b_pair_a_a, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_m_b_b_pair_a_b, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_m_b_b_pair_a_m_a, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_m_b_b_pair_a_m_b, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_m_b_b_pair_b_a, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_m_b_b_pair_b_b, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_m_b_b_pair_b_m_a, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_m_b_b_pair_b_m_b, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_m_b_b_pair_m_a_a, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_m_b_b_pair_m_a_b, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_m_b_b_pair_m_a_m_a, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_m_b_b_pair_m_a_m_b, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_m_b_b_pair_m_b_a, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_m_b_b_pair_m_b_b, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_m_b_b_pair_m_b_m_a, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_m_b_b_pair_m_b_m_b, axiom, (m_fn_m_b_b => (((m_b => b) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_m_b_m_a_pair_a_a, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_m_b_m_a_pair_a_b, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_m_b_m_a_pair_a_m_a, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_m_b_m_a_pair_a_m_b, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_m_b_m_a_pair_b_a, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_m_b_m_a_pair_b_b, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_m_b_m_a_pair_b_m_a, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_m_b_m_a_pair_b_m_b, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_m_b_m_a_pair_m_a_a, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_m_b_m_a_pair_m_a_b, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_m_b_m_a_pair_m_a_m_a, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_m_b_m_a_pair_m_a_m_b, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_m_b_m_a_pair_m_b_a, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_m_b_m_a_pair_m_b_b, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_m_b_m_a_pair_m_b_m_a, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_m_b_m_a_pair_m_b_m_b, axiom, (m_fn_m_b_m_a => (((m_b => m_a) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_fn_m_b_m_b_pair_a_a, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_a_a) => m_pair_a_a)) ).
fof(bind_fn_m_b_m_b_pair_a_b, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_a_b) => m_pair_a_b)) ).
fof(bind_fn_m_b_m_b_pair_a_m_a, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_a_m_a) => m_pair_a_m_a)) ).
fof(bind_fn_m_b_m_b_pair_a_m_b, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_a_m_b) => m_pair_a_m_b)) ).
fof(bind_fn_m_b_m_b_pair_b_a, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_b_a) => m_pair_b_a)) ).
fof(bind_fn_m_b_m_b_pair_b_b, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_b_b) => m_pair_b_b)) ).
fof(bind_fn_m_b_m_b_pair_b_m_a, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_b_m_a) => m_pair_b_m_a)) ).
fof(bind_fn_m_b_m_b_pair_b_m_b, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_b_m_b) => m_pair_b_m_b)) ).
fof(bind_fn_m_b_m_b_pair_m_a_a, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_m_a_a) => m_pair_m_a_a)) ).
fof(bind_fn_m_b_m_b_pair_m_a_b, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_m_a_b) => m_pair_m_a_b)) ).
fof(bind_fn_m_b_m_b_pair_m_a_m_a, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_m_a_m_a) => m_pair_m_a_m_a)) ).
fof(bind_fn_m_b_m_b_pair_m_a_m_b, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_m_a_m_b) => m_pair_m_a_m_b)) ).
fof(bind_fn_m_b_m_b_pair_m_b_a, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_m_b_a) => m_pair_m_b_a)) ).
fof(bind_fn_m_b_m_b_pair_m_b_b, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_m_b_b) => m_pair_m_b_b)) ).
fof(bind_fn_m_b_m_b_pair_m_b_m_a, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_m_b_m_a) => m_pair_m_b_m_a)) ).
fof(bind_fn_m_b_m_b_pair_m_b_m_b, axiom, (m_fn_m_b_m_b => (((m_b => m_b) => m_pair_m_b_m_b) => m_pair_m_b_m_b)) ).
...
fof(bind_pair_a_a_fn_a_a, axiom, (m_pair_a_a => (((a & a) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_a_a_fn_a_b, axiom, (m_pair_a_a => (((a & a) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_a_a_fn_a_m_a, axiom, (m_pair_a_a => (((a & a) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_a_a_fn_a_m_b, axiom, (m_pair_a_a => (((a & a) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_a_a_fn_b_a, axiom, (m_pair_a_a => (((a & a) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_a_a_fn_b_b, axiom, (m_pair_a_a => (((a & a) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_a_a_fn_b_m_a, axiom, (m_pair_a_a => (((a & a) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_a_a_fn_b_m_b, axiom, (m_pair_a_a => (((a & a) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_a_a_fn_m_a_a, axiom, (m_pair_a_a => (((a & a) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_a_a_fn_m_a_b, axiom, (m_pair_a_a => (((a & a) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_a_a_fn_m_a_m_a, axiom, (m_pair_a_a => (((a & a) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_a_a_fn_m_a_m_b, axiom, (m_pair_a_a => (((a & a) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_a_a_fn_m_b_a, axiom, (m_pair_a_a => (((a & a) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_a_a_fn_m_b_b, axiom, (m_pair_a_a => (((a & a) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_a_a_fn_m_b_m_a, axiom, (m_pair_a_a => (((a & a) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_a_a_fn_m_b_m_b, axiom, (m_pair_a_a => (((a & a) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_a_b_fn_a_a, axiom, (m_pair_a_b => (((a & b) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_a_b_fn_a_b, axiom, (m_pair_a_b => (((a & b) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_a_b_fn_a_m_a, axiom, (m_pair_a_b => (((a & b) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_a_b_fn_a_m_b, axiom, (m_pair_a_b => (((a & b) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_a_b_fn_b_a, axiom, (m_pair_a_b => (((a & b) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_a_b_fn_b_b, axiom, (m_pair_a_b => (((a & b) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_a_b_fn_b_m_a, axiom, (m_pair_a_b => (((a & b) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_a_b_fn_b_m_b, axiom, (m_pair_a_b => (((a & b) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_a_b_fn_m_a_a, axiom, (m_pair_a_b => (((a & b) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_a_b_fn_m_a_b, axiom, (m_pair_a_b => (((a & b) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_a_b_fn_m_a_m_a, axiom, (m_pair_a_b => (((a & b) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_a_b_fn_m_a_m_b, axiom, (m_pair_a_b => (((a & b) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_a_b_fn_m_b_a, axiom, (m_pair_a_b => (((a & b) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_a_b_fn_m_b_b, axiom, (m_pair_a_b => (((a & b) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_a_b_fn_m_b_m_a, axiom, (m_pair_a_b => (((a & b) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_a_b_fn_m_b_m_b, axiom, (m_pair_a_b => (((a & b) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_a_m_a_fn_a_a, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_a_m_a_fn_a_b, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_a_m_a_fn_a_m_a, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_a_m_a_fn_a_m_b, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_a_m_a_fn_b_a, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_a_m_a_fn_b_b, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_a_m_a_fn_b_m_a, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_a_m_a_fn_b_m_b, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_a_m_a_fn_m_a_a, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_a_m_a_fn_m_a_b, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_a_m_a_fn_m_a_m_a, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_a_m_a_fn_m_a_m_b, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_a_m_a_fn_m_b_a, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_a_m_a_fn_m_b_b, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_a_m_a_fn_m_b_m_a, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_a_m_a_fn_m_b_m_b, axiom, (m_pair_a_m_a => (((a & m_a) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_a_m_b_fn_a_a, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_a_m_b_fn_a_b, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_a_m_b_fn_a_m_a, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_a_m_b_fn_a_m_b, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_a_m_b_fn_b_a, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_a_m_b_fn_b_b, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_a_m_b_fn_b_m_a, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_a_m_b_fn_b_m_b, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_a_m_b_fn_m_a_a, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_a_m_b_fn_m_a_b, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_a_m_b_fn_m_a_m_a, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_a_m_b_fn_m_a_m_b, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_a_m_b_fn_m_b_a, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_a_m_b_fn_m_b_b, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_a_m_b_fn_m_b_m_a, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_a_m_b_fn_m_b_m_b, axiom, (m_pair_a_m_b => (((a & m_b) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_b_a_fn_a_a, axiom, (m_pair_b_a => (((b & a) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_b_a_fn_a_b, axiom, (m_pair_b_a => (((b & a) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_b_a_fn_a_m_a, axiom, (m_pair_b_a => (((b & a) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_b_a_fn_a_m_b, axiom, (m_pair_b_a => (((b & a) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_b_a_fn_b_a, axiom, (m_pair_b_a => (((b & a) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_b_a_fn_b_b, axiom, (m_pair_b_a => (((b & a) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_b_a_fn_b_m_a, axiom, (m_pair_b_a => (((b & a) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_b_a_fn_b_m_b, axiom, (m_pair_b_a => (((b & a) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_b_a_fn_m_a_a, axiom, (m_pair_b_a => (((b & a) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_b_a_fn_m_a_b, axiom, (m_pair_b_a => (((b & a) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_b_a_fn_m_a_m_a, axiom, (m_pair_b_a => (((b & a) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_b_a_fn_m_a_m_b, axiom, (m_pair_b_a => (((b & a) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_b_a_fn_m_b_a, axiom, (m_pair_b_a => (((b & a) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_b_a_fn_m_b_b, axiom, (m_pair_b_a => (((b & a) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_b_a_fn_m_b_m_a, axiom, (m_pair_b_a => (((b & a) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_b_a_fn_m_b_m_b, axiom, (m_pair_b_a => (((b & a) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_b_b_fn_a_a, axiom, (m_pair_b_b => (((b & b) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_b_b_fn_a_b, axiom, (m_pair_b_b => (((b & b) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_b_b_fn_a_m_a, axiom, (m_pair_b_b => (((b & b) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_b_b_fn_a_m_b, axiom, (m_pair_b_b => (((b & b) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_b_b_fn_b_a, axiom, (m_pair_b_b => (((b & b) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_b_b_fn_b_b, axiom, (m_pair_b_b => (((b & b) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_b_b_fn_b_m_a, axiom, (m_pair_b_b => (((b & b) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_b_b_fn_b_m_b, axiom, (m_pair_b_b => (((b & b) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_b_b_fn_m_a_a, axiom, (m_pair_b_b => (((b & b) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_b_b_fn_m_a_b, axiom, (m_pair_b_b => (((b & b) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_b_b_fn_m_a_m_a, axiom, (m_pair_b_b => (((b & b) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_b_b_fn_m_a_m_b, axiom, (m_pair_b_b => (((b & b) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_b_b_fn_m_b_a, axiom, (m_pair_b_b => (((b & b) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_b_b_fn_m_b_b, axiom, (m_pair_b_b => (((b & b) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_b_b_fn_m_b_m_a, axiom, (m_pair_b_b => (((b & b) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_b_b_fn_m_b_m_b, axiom, (m_pair_b_b => (((b & b) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_b_m_a_fn_a_a, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_b_m_a_fn_a_b, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_b_m_a_fn_a_m_a, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_b_m_a_fn_a_m_b, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_b_m_a_fn_b_a, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_b_m_a_fn_b_b, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_b_m_a_fn_b_m_a, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_b_m_a_fn_b_m_b, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_b_m_a_fn_m_a_a, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_b_m_a_fn_m_a_b, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_b_m_a_fn_m_a_m_a, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_b_m_a_fn_m_a_m_b, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_b_m_a_fn_m_b_a, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_b_m_a_fn_m_b_b, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_b_m_a_fn_m_b_m_a, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_b_m_a_fn_m_b_m_b, axiom, (m_pair_b_m_a => (((b & m_a) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_b_m_b_fn_a_a, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_b_m_b_fn_a_b, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_b_m_b_fn_a_m_a, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_b_m_b_fn_a_m_b, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_b_m_b_fn_b_a, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_b_m_b_fn_b_b, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_b_m_b_fn_b_m_a, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_b_m_b_fn_b_m_b, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_b_m_b_fn_m_a_a, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_b_m_b_fn_m_a_b, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_b_m_b_fn_m_a_m_a, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_b_m_b_fn_m_a_m_b, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_b_m_b_fn_m_b_a, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_b_m_b_fn_m_b_b, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_b_m_b_fn_m_b_m_a, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_b_m_b_fn_m_b_m_b, axiom, (m_pair_b_m_b => (((b & m_b) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_m_a_a_fn_a_a, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_m_a_a_fn_a_b, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_m_a_a_fn_a_m_a, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_m_a_a_fn_a_m_b, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_m_a_a_fn_b_a, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_m_a_a_fn_b_b, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_m_a_a_fn_b_m_a, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_m_a_a_fn_b_m_b, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_m_a_a_fn_m_a_a, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_m_a_a_fn_m_a_b, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_m_a_a_fn_m_a_m_a, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_m_a_a_fn_m_a_m_b, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_m_a_a_fn_m_b_a, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_m_a_a_fn_m_b_b, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_m_a_a_fn_m_b_m_a, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_m_a_a_fn_m_b_m_b, axiom, (m_pair_m_a_a => (((m_a & a) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_m_a_b_fn_a_a, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_m_a_b_fn_a_b, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_m_a_b_fn_a_m_a, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_m_a_b_fn_a_m_b, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_m_a_b_fn_b_a, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_m_a_b_fn_b_b, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_m_a_b_fn_b_m_a, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_m_a_b_fn_b_m_b, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_m_a_b_fn_m_a_a, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_m_a_b_fn_m_a_b, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_m_a_b_fn_m_a_m_a, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_m_a_b_fn_m_a_m_b, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_m_a_b_fn_m_b_a, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_m_a_b_fn_m_b_b, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_m_a_b_fn_m_b_m_a, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_m_a_b_fn_m_b_m_b, axiom, (m_pair_m_a_b => (((m_a & b) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_m_a_m_a_fn_a_a, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_m_a_m_a_fn_a_b, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_m_a_m_a_fn_a_m_a, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_m_a_m_a_fn_a_m_b, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_m_a_m_a_fn_b_a, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_m_a_m_a_fn_b_b, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_m_a_m_a_fn_b_m_a, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_m_a_m_a_fn_b_m_b, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_m_a_m_a_fn_m_a_a, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_m_a_m_a_fn_m_a_b, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_m_a_m_a_fn_m_a_m_a, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_m_a_m_a_fn_m_a_m_b, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_m_a_m_a_fn_m_b_a, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_m_a_m_a_fn_m_b_b, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_m_a_m_a_fn_m_b_m_a, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_m_a_m_a_fn_m_b_m_b, axiom, (m_pair_m_a_m_a => (((m_a & m_a) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_m_a_m_b_fn_a_a, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_m_a_m_b_fn_a_b, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_m_a_m_b_fn_a_m_a, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_m_a_m_b_fn_a_m_b, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_m_a_m_b_fn_b_a, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_m_a_m_b_fn_b_b, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_m_a_m_b_fn_b_m_a, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_m_a_m_b_fn_b_m_b, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_m_a_m_b_fn_m_a_a, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_m_a_m_b_fn_m_a_b, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_m_a_m_b_fn_m_a_m_a, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_m_a_m_b_fn_m_a_m_b, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_m_a_m_b_fn_m_b_a, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_m_a_m_b_fn_m_b_b, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_m_a_m_b_fn_m_b_m_a, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_m_a_m_b_fn_m_b_m_b, axiom, (m_pair_m_a_m_b => (((m_a & m_b) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_m_b_a_fn_a_a, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_m_b_a_fn_a_b, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_m_b_a_fn_a_m_a, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_m_b_a_fn_a_m_b, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_m_b_a_fn_b_a, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_m_b_a_fn_b_b, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_m_b_a_fn_b_m_a, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_m_b_a_fn_b_m_b, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_m_b_a_fn_m_a_a, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_m_b_a_fn_m_a_b, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_m_b_a_fn_m_a_m_a, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_m_b_a_fn_m_a_m_b, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_m_b_a_fn_m_b_a, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_m_b_a_fn_m_b_b, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_m_b_a_fn_m_b_m_a, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_m_b_a_fn_m_b_m_b, axiom, (m_pair_m_b_a => (((m_b & a) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_m_b_b_fn_a_a, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_m_b_b_fn_a_b, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_m_b_b_fn_a_m_a, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_m_b_b_fn_a_m_b, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_m_b_b_fn_b_a, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_m_b_b_fn_b_b, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_m_b_b_fn_b_m_a, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_m_b_b_fn_b_m_b, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_m_b_b_fn_m_a_a, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_m_b_b_fn_m_a_b, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_m_b_b_fn_m_a_m_a, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_m_b_b_fn_m_a_m_b, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_m_b_b_fn_m_b_a, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_m_b_b_fn_m_b_b, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_m_b_b_fn_m_b_m_a, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_m_b_b_fn_m_b_m_b, axiom, (m_pair_m_b_b => (((m_b & b) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_m_b_m_a_fn_a_a, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_m_b_m_a_fn_a_b, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_m_b_m_a_fn_a_m_a, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_m_b_m_a_fn_a_m_b, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_m_b_m_a_fn_b_a, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_m_b_m_a_fn_b_b, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_m_b_m_a_fn_b_m_a, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_m_b_m_a_fn_b_m_b, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_m_b_m_a_fn_m_a_a, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_m_b_m_a_fn_m_a_b, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_m_b_m_a_fn_m_a_m_a, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_m_b_m_a_fn_m_a_m_b, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_m_b_m_a_fn_m_b_a, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_m_b_m_a_fn_m_b_b, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_m_b_m_a_fn_m_b_m_a, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_m_b_m_a_fn_m_b_m_b, axiom, (m_pair_m_b_m_a => (((m_b & m_a) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
...
fof(bind_pair_m_b_m_b_fn_a_a, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_a_a) => m_fn_a_a)) ).
fof(bind_pair_m_b_m_b_fn_a_b, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_a_b) => m_fn_a_b)) ).
fof(bind_pair_m_b_m_b_fn_a_m_a, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_a_m_a) => m_fn_a_m_a)) ).
fof(bind_pair_m_b_m_b_fn_a_m_b, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_a_m_b) => m_fn_a_m_b)) ).
fof(bind_pair_m_b_m_b_fn_b_a, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_b_a) => m_fn_b_a)) ).
fof(bind_pair_m_b_m_b_fn_b_b, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_b_b) => m_fn_b_b)) ).
fof(bind_pair_m_b_m_b_fn_b_m_a, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_b_m_a) => m_fn_b_m_a)) ).
fof(bind_pair_m_b_m_b_fn_b_m_b, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_b_m_b) => m_fn_b_m_b)) ).
fof(bind_pair_m_b_m_b_fn_m_a_a, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_m_a_a) => m_fn_m_a_a)) ).
fof(bind_pair_m_b_m_b_fn_m_a_b, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_m_a_b) => m_fn_m_a_b)) ).
fof(bind_pair_m_b_m_b_fn_m_a_m_a, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_m_a_m_a) => m_fn_m_a_m_a)) ).
fof(bind_pair_m_b_m_b_fn_m_a_m_b, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_m_a_m_b) => m_fn_m_a_m_b)) ).
fof(bind_pair_m_b_m_b_fn_m_b_a, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_m_b_a) => m_fn_m_b_a)) ).
fof(bind_pair_m_b_m_b_fn_m_b_b, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_m_b_b) => m_fn_m_b_b)) ).
fof(bind_pair_m_b_m_b_fn_m_b_m_a, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_m_b_m_a) => m_fn_m_b_m_a)) ).
fof(bind_pair_m_b_m_b_fn_m_b_m_b, axiom, (m_pair_m_b_m_b => (((m_b & m_b) => m_fn_m_b_m_b) => m_fn_m_b_m_b)) ).
